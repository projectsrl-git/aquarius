...
ALTER TABLE [dbo].[U_BOL_DD] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_BOL_DD_ORD_CLDOG] DEFAULT ('') FOR [ORD_CLDOG],
	CONSTRAINT [DF_U_BOL_DD_ORD_SERV_INTRA] DEFAULT ('') FOR [ORD_SERV_INTRA]
go

UPDATE U_BOL_DD SET ORD_CLDOG = ''
UPDATE U_BOL_DD SET ORD_SERV_INTRA = ''
