...
ALTER TABLE [dbo].[U_BFO_DL] WITH NOCHECK ADD 
   	    CONSTRAINT [DF_U_BFO_DL_ORD_QUAPRO] DEFAULT ('') FOR [ORD_QUAPRO],
   	    CONSTRAINT [DF_U_BFO_DL_ORD_CLIENT] DEFAULT ('') FOR [ORD_CLIENT]

go

UPDATE U_BFO_DL SET ORD_QUAPRO 	= '' 
UPDATE U_BFO_DL SET ORD_CLIENT 	= '' 