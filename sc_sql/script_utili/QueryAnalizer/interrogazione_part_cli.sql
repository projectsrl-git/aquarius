...
select * from part_cli where par_anno = '2011' order by par_numpro,par_nprog

select par_npart,par_numfat,par_tmov,par_tipfat,par_fatt,* from part_cli  order by par_numpro,par_nprog
