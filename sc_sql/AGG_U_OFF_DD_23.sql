...
ALTER TABLE [dbo].[U_OFF_DD] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_OFF_DD_ORD_CLDOG] DEFAULT ('') FOR [ORD_CLDOG],
	CONSTRAINT [DF_U_OFF_DD_ORD_SERV_INTRA] DEFAULT ('') FOR [ORD_SERV_INTRA]
go

UPDATE U_OFF_DD SET ORD_CLDOG = ''
UPDATE U_OFF_DD SET ORD_SERV_INTRA = ''
