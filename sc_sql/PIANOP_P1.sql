if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[PIANOP_P1]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[PIANOP_P1]
GO
 
CREATE TABLE [dbo].[PIANOP_P1] (
...
ALTER TABLE [dbo].[PIANOP_P1] WITH NOCHECK ADD 
	CONSTRAINT [PK_PIANOP_P1] PRIMARY KEY  CLUSTERED 
	(
		[id_unique]
	)  ON [PRIMARY] 
GO
...
ALTER TABLE [dbo].[PIANOP_P1] WITH NOCHECK ADD 
	CONSTRAINT [DF_PIANOP_P1_id_unique] DEFAULT (newid()) FOR [id_unique],
	CONSTRAINT [DF_PIANOP_P1_SELEZIONE]  DEFAULT ('') FOR [SELEZIONE],
	CONSTRAINT [DF_PIANOP_P1_LEGA_SPLIT]  DEFAULT ('') FOR [LEGA_SPLIT],
	CONSTRAINT [DF_PIANOP_P1_ID_PARTITA]  DEFAULT ('') FOR [ID_PARTITA], 
	CONSTRAINT [DF_PIANOP_P1_tipologia]  DEFAULT ('') FOR [tipologia], 
	CONSTRAINT [DF_PIANOP_P1_ragsoc]  DEFAULT ('') FOR [ragsoc],    
	CONSTRAINT [DF_PIANOP_P1_contabilit]  DEFAULT ('') FOR [contabilit],
	CONSTRAINT [DF_PIANOP_P1_npart]  DEFAULT (0) FOR [npart],
	CONSTRAINT [DF_PIANOP_P1_dtscad]  DEFAULT ('') FOR [dtscad],
	CONSTRAINT [DF_PIANOP_P1_nsaldo]  DEFAULT (0) FOR  [nsaldo], 
    CONSTRAINT [DF_PIANOP_P1_ANOMALIA]  DEFAULT ('') FOR  [ANOMALIA]
GO                               