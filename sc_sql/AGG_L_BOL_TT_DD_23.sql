...
ALTER TABLE [dbo].[L_BOL_TT] WITH NOCHECK ADD 
	CONSTRAINT [DF_L_BOL_TT_ORD_CONCON] DEFAULT ('') FOR [ORD_CONCON]
go

UPDATE L_BOL_TT SET ORD_CONCON = ''
...
ALTER TABLE [dbo].[L_BOL_DD] WITH NOCHECK ADD 
	CONSTRAINT [DF_L_BOL_DD_ORD_CCODET] DEFAULT ('') FOR [ORD_CCODET],
	CONSTRAINT [DF_L_BOL_DD_ORD_CONDET] DEFAULT ('') FOR [ORD_CONDET]
go

UPDATE L_BOL_DD SET ORD_CCODET = ''
UPDATE L_BOL_DD SET ORD_CONDET = ''
