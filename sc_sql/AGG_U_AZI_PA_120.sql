...
ALTER TABLE [dbo].[U_AZI_PA] ADD 
	 AZI_INTRA_TISEZ varchar(5) COLLATE Latin1_General_CI_AS NULL
go
-- forzature di default (vedi script standard per valorizzare campi diversi da varchar)
ALTER TABLE [dbo].[U_AZI_PA] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_AZI_PA_AZI_INTRA_TISEZ] DEFAULT ('') FOR [AZI_INTRA_TISEZ]
go

UPDATE U_AZI_PA SET AZI_INTRA_TISEZ = ''
