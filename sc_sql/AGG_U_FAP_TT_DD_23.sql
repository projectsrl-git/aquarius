...
ALTER TABLE [dbo].[U_FAP_TT] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_FAP_TT_ORD_CONCON] DEFAULT ('') FOR [ORD_CONCON]
go

UPDATE U_FAP_TT SET ORD_CONCON = ''
...
ALTER TABLE [dbo].[U_FAP_DD] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_FAP_DD_ORD_CCODET] DEFAULT ('') FOR [ORD_CCODET],
	CONSTRAINT [DF_U_FAP_DD_ORD_CONDET] DEFAULT ('') FOR [ORD_CONDET]
go

UPDATE U_FAP_DD SET ORD_CCODET = ''
UPDATE U_FAP_DD SET ORD_CONDET = ''
