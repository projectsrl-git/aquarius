...
ALTER TABLE [dbo].[U_BOL_TT] WITH NOCHECK ADD 
        CONSTRAINT [DF_U_BOL_TT_ORD_NUMCOC] DEFAULT ('') FOR [ORD_NUMCOC],
        CONSTRAINT [DF_U_BOL_TT_ORD_DATCOC] DEFAULT ('') FOR [ORD_DATCOC]
go



UPDATE U_BOL_TT SET ORD_NUMCOC 	= ''
UPDATE U_BOL_TT SET ORD_DATCOC 	= ''
