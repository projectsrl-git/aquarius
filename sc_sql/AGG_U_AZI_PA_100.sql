...
***		- % di recupero per carico materiale da ri-macinare
*/

ALTER TABLE [DBO].[U_AZI_PA] ADD 
	AZI_PERRIM NUMERIC(6,2) NULL
GO

ALTER TABLE [DBO].[U_AZI_PA] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_AZI_PA_AZI_PERRIM] DEFAULT (0) FOR [AZI_PERRIM]
GO

UPDATE U_AZI_PA SET AZI_PERRIM = 0
