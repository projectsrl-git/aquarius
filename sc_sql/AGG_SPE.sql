...
ALTER TABLE [dbo].[U_SPE_DD] WITH NOCHECK ADD 
	CONSTRAINT [DF_U_SPE_DD_ORD_CODTAG] DEFAULT ('') FOR [ORD_CODTAG],
	CONSTRAINT [DF_U_SPE_DD_ORD_DESTAG] DEFAULT ('') FOR [ORD_DESTAG],
	CONSTRAINT [DF_U_SPE_DD_ORD_CODCOL] DEFAULT ('') FOR [ORD_CODCOL],
	CONSTRAINT [DF_U_SPE_DD_ORD_DESCOL] DEFAULT ('') FOR [ORD_DESCOL]
go
