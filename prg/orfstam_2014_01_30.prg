*********************************************************************************************
*								STAMPA CONFERMA D'ORDINE DI ACQUISTO						*
*********************************************************************************************
...
_FILEPDF = "C:\ORF-n-" + ALLTRIM(V_NUMORD) + "-del-" + STRTRAN(RIBALTA2(V_DATA),'/','-') + "-" + TOGLI_CARATTERI_SPECIALI(ALLTRIM(SUBSTR(V_RAGSOC,1,35))) + ".EXP"
**=> ERASMO - FINE 01/07/2013

IF FLAG_STAMPA_ORDINI_IN_INGLESE

	   DO PRG\MENUSTA1 WITH "CU_ORF_DD",.t.,.T.,"XXX","ORFPJING","ORFPJING.FRX",.F.,_FILEPDF

ELSE
	IF XXX_TIPO
	   DO PRG\MENUSTA1 WITH "CU_ORF_DD",.t.,.T.,"XXX","PRTPJEUR","PRTPJEUR.FRX",.F.,_FILEPDF
	ELSE
	   DO PRG\MENUSTA1 WITH "CU_ORF_DD",.t.,.T.,"XXX","ORFPJEUR","ORFPJEUR.FRX",.F.,_FILEPDF
	ENDIF
ENDIF
...
PUB_IVADEF = CERCA_IVA_DEFAULT("CU_ORF_DD","CODICE")  
PUB_ALIQ = CERCA_IVA_DEFAULT("CU_ORF_DD","ALIQUOTA")  
...
IF checkConSpe(V_PAG)
	=SCADENZE_SPECIALI(M.TIPRENDO,.F.,.F.,.T.,"CU_ORF_DD",.F.)
ENDIF
