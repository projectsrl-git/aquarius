***********************************************************************************
PROCEDURE GESTIONE_AGGINCASSO  			 && RICARICA/SCARICA IL MAGAZZINO E I SALDI
***********************************************************************************

RELEASE PUB_CODSOC,PUB_VALRIF
PUBLIC  PUB_CODSOC,PUB_VALRIF
PUB_CODSOC = '01'
PUB_VALRIF = 'EUR'

x_cond = "cas_flgtra = 1 and cas_trasme = 1"
...
FUNCTION MOVIMAGA
PARAMETERS _DADOVE,_GENMOV,_TIPO,_IMPE,_MAGSCA,_MAGCAR,_CODART,_TOPSCA,_TOPCAR,_QUANTI,_NUMDOC,_DATDOC,_DATREG,_ORAMOV,_CLIFOR,_PRZACQ,_PRZVEN,_CODIVA,_SCONTO,_VALUTA,_NOTE,_CSC,_SAC,_GGG,_FORNIT,_FLGTRA,_CODPDV
...
RELEASE M_CLIFOR,M_RAGSOC,M_FORNIT,M_DESFOR,M_PRIMOF,M_QTAFOR,M_QUANTI,M_GENMOV,M_GIAFOR,M_CODPDV
PUBLIC  M_CLIFOR,M_RAGSOC,M_FORNIT,M_DESFOR,M_PRIMOF,M_QTAFOR,M_QUANTI,M_GENMOV,M_GIAFOR,M_CODPDV
M_CLIFOR = _CLIFOR
M_RAGSOC = ""
M_FORNIT = ""
M_DESFOR = ""
...
REPLACE CAS_CODCAS WITH M.CAS_CODCAS
REPLACE CAS_CODMAG WITH M.CAS_CODMAG
=CAMBIADT(M.CAS_DATOPE,"CAS_DATOPE")
REPLACE CAS_ORAOPE WITH M.CAS_ORAOPE
REPLACE CAS_VALCON WITH M.CAS_VALCON
REPLACE CAS_VALNOC WITH M.CAS_VALNOC
REPLACE CAS_VALPOS WITH M.CAS_VALPOS
REPLACE CAS_VALCAR WITH M.CAS_VALCAR
REPLACE CAS_VALASS WITH M.CAS_VALASS
REPLACE CAS_VALFIN WITH M.CAS_VALFIN
REPLACE CAS_VALALT WITH M.CAS_VALALT
