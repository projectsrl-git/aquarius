...
*																											   *
*			    CREAZIONE AUTOMATICA DI UNA SECONDA REGISTRAZIONE NEL CASO DI :	       					       *
...
**=> ERA/SER - INIZIO 05/04/2016
*** GESTIONE OMAGGI CON IVA A CARICO AZIENDA
RELEASE VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO,VALORE_IMPOSTA_OMAGGIO_RICALCOLATO,VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO
PUBLIC VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO,VALORE_IMPOSTA_OMAGGIO_RICALCOLATO,VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO
VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO = 0
VALORE_IMPOSTA_OMAGGIO_RICALCOLATO = 0
VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO = 0
**=> ERA/SER - FINE 05/04/2016
...
** ########################################################### INIZIO ELABORAZIONE FATTURA/E (ERA/SER)#########################################################
...
*!*	2017/06/26 SERGIO/ERASMO PERICOLOSISSIMO SCARTA GLI ARTICOLI CON TRE ASTERISCHI		 
...
*!*			 **=> ERASMO - FINE 12/08/2015 - SU SPECIFICA RICHIESTA DEL CLIENTE
		 ...
		 __UNITA_SUPPL_INTRA 	= ORD_QTAORD  && ERASMO - 22/10/2018
   ...
   ** ####################################################### CREAZIONE DELLE REGISTRAZIONI CONTABILI (ERA/SER) ##########################################
   ...
   *** FABIANO 02/03/2015 - GESTIONE ANTICIPI
	...
	**=> ERA/SER - INIZIO 05/04/2016
	*** INIZIALIZZO LE VARIABILI PER LA GESTIONE DELL'IVA OMAGGI A CARICO AZIENDA
	VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO = 0
	VALORE_IMPOSTA_OMAGGIO_RICALCOLATO = 0
	VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO = 0
	**=> ERA/SER - FINE 05/04/2016
...
*!*		  Z_PROVIN_DESTI_INTRA		= '' 			&& INTRASTAT
      ...
      ** ARTICOLO OMAGGIO CON IVA A CARICO AZIENDA : CREA SECONDA REGISTRAZIONE
	  IF W_OMAGGIO <> 0
  		   *VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO = VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO + W_OMAGGIO + VALORE_POLIECO
  		   VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO = VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO + W_OMAGGIO  && ERASMO/FABIANO - 21/06/2016 - L'ARTICOLO POLIECO E' GIA' CONFIGURATO COME OMAGGIO (W_OMAGGIO), QUINDI NON VA SOMMATO ANCORA IL SUO VALORE
  		   IF W_IMPOSTA <> 0
  		      *VALORE_IMPOSTA_OMAGGIO_RICALCOLATO = VALORE_IMPOSTA_OMAGGIO_RICALCOLATO + W_IMPOSTA + IMPOSTA_POLIECO
  		      VALORE_IMPOSTA_OMAGGIO_RICALCOLATO = VALORE_IMPOSTA_OMAGGIO_RICALCOLATO + W_IMPOSTA  && ERASMO/FABIANO - 21/06/2016 - L'ARTICOLO POLIECO E' GIA' CONFIGURATO COME OMAGGIO (W_OMAGGIO), QUINDI NON VA SOMMATO ANCORA LA SUA IMPOSTA
  		   ENDIF
  		   VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO = VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO + VALORE_IMPOSTA_OMAGGIO_RICALCOLATO    
      ENDIF
      **=> ERA/SER - FINE 05/04/2016
  ...
  **=> ERA/SER - INIZIO 05/04/2016
  =CREA_REGISTRAZIONI_OMAGGIO_IVA_CARICO_AZIENDA()
  **=> ERA/SER - FINE 05/04/2016
...
IF PUB_TPAEGRU	 
	...
	*** SE POPOLATO, CONSIDERO IL GRUPPO MERCEOLOGICO INDUSTRIALE DA CANALE DI VENDITA DEL CLIENTE, 
	*** PER GUIDARE L'ACQUISIZIONE DEL CONTO DI VENDITA DA CLIENTE PIUTTOSTO CHE DALL'ARTICOLO
	__GRUPPO_MERCEOLOGICO_INDUSTRIALE = IIF(!EMPTY(CERCA_GMI_CANVEN_CLI(V_CODCLI)),CERCA_GMI_CANVEN_CLI(V_CODCLI),__GRUPPO_MERCEOLOGICO_INDUSTRIALE)
...
**=> ERASMO/SERGIO - INIZIO 10/12/2018
*** SPOSTO QUESTA GESTIONE IN QUESTO PUNTO PER ASSICURARMI CHE PRELEVI LA CONTROPARTITA DAL PARAMETRO LINEA/NAZIONE
** 1.7) ACCESSO SE RICHIESTO AL PARAMETRO LINEA / NAZIONE 
IF _TLIN && VERIFICA SE RICHIESTO
   v_seek	= 'CRA'+ALLTRIM(_LIN)+ALLTRIM(_NAZ)
   v_chiave = "codice"
...
**=> ERA/SER - INIZIO 05/04/2016
*******************************************************
PROCEDURE CREA_REGISTRAZIONI_OMAGGIO_IVA_CARICO_AZIENDA
*******************************************************
 
IF VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO = 0
  RETURN
ENDIF
...
*!*	SELECT SUM(W_PUBBLI) AS SOMMA_W_PUBBLI, SUM(W_OMAGGIO) AS SOMMA_W_OMAGGIO FROM W_FAT INTO CURSOR TMP_W_FAT
*!*	SELECT TMP_W_FAT
*!*	GO TOP

*!*	_SOMMA_W_PUBBLI = SOMMA_W_PUBBLI
*!*	_SOMMA_W_OMAGGIO = SOMMA_W_OMAGGIO 
_ARPU = "O"
...
*!*	   DO REG_NUMRPN
*!*	   DO REG_NUMREG
*!*	   DO MOVCREAT WITH DAVA,VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA	    &&TESTATA
*!*	   DO MOVCREAI WITH DAVA,VALORE_IMPONIBILE_IMPOSTA_OMAGGIO_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA		&&INDICE
...
*!*	   
*!*	   DO MOVCREA WITH DAVD,VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO,0,'NO',V_AOM,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_OKDIFC,_ARPU,_SOMMA_W_PUBBLI,_SOMMA_W_OMAGGIO,_CODCOMMESSA,Z_CODCCO   	&&DET VENDITA
*!*	   =CARICA_RIEPILOGHI_CONTABILI(V_AOM,'',VALORE_PUBBLI_RICALCOLATO,GETDCON(V_AOM))
*!*		 
*!*	   IF VALORE_IMPOSTA_OMAGGIO_RICALCOLATO <> 0
*!*		  DO MOVCREA WITH DAVD,VALORE_IMPOSTA_OMAGGIO_RICALCOLATO,0,'NO',V_CIO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_OKDIFC,_ARPU,_SOMMA_W_PUBBLI,_SOMMA_W_OMAGGIO,_CODCOMMESSA,Z_CODCCO   	&&DET VENDITA
...
*!*	   DO MOVCREAT WITH DAVA,VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA	    &&TESTATA
*!*	   DO MOVCREAI WITH DAVA,VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA		&&INDICE
...
*!*	   =CARICA_RIEPILOGHI_CONTABILI(V_AOM,'',VALORE_IMPONIBILE_OMAGGIO_RICALCOLATO,GETDCON(V_AOM))
...
*!*		   DO REG_NUMREG
*!*	       
*!*		   DO movcreat WITH DAVA,VALORE_IMPOSTA_OMAGGIO_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA	    &&TESTATA
*!*		   DO movcreai WITH DAVA,VALORE_IMPOSTA_OMAGGIO_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA		&&INDICE
*!*	       =CARICA_RIEPILOGHI_CONTABILI(M.CONTO,'',VALORE_IMPOSTA_OMAGGIO_RICALCOLATO,GETDCON(M.CONTO))
*!*	       
*!*	       OLD_DESF = XDESF
*!*	       XDESF    = "CLI:"+CERCA_CLI(ALLTRIM(SUBSTR(M.CONTO,PUB_SOTTOG,PUB_CONTO)))+" N.F:"+M.OLFAT+" DEL "+M.DTD
*!*	       XDESF    = DESCRIZIONE_AUTOMATICA(XDESF,ALLTRIM(SUBSTR(M.CONTO,PUB_SOTTOG,PUB_CONTO)),M.OLFAT,M.DTD)   
...
IF PUB_OMACIO2  && TRASFERISCE FATTURATO CON IVA A CARICO AZIENDA (OMAGGI) CREANDO 2 REGISTRAZIONI AL POSTO DI 3 REGISTRAZIONI
   ...
   *** RAGGRUPPO PER CENTRO DI COSTO
   SELECT W_CCOSTO, SUM(W_PUBBLI) AS SOMMA_W_PUBBLI, SUM(W_OMAGGIO) AS SOMMA_W_OMAGGIO, SUM(W_IMPOSTA) AS SOMMA_W_IMPOSTA FROM W_FAT GROUP BY W_CCOSTO INTO CURSOR TMP_W_FAT
   SELECT TMP_W_FAT
   GO TOP
   SCAN
      Z_CODCCO = W_CCOSTO
      _SOMMA_W_PUBBLI = SOMMA_W_PUBBLI
      _SOMMA_W_OMAGGIO = SOMMA_W_OMAGGIO 
      _SOMMA_W_IMPOSTA = SOMMA_W_IMPOSTA 
   
      DO MOVCREA WITH DAVD,_SOMMA_W_OMAGGIO,0,'NO',V_AOM,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_OKDIFC,_ARPU,_SOMMA_W_PUBBLI,_SOMMA_W_OMAGGIO,_CODCOMMESSA,Z_CODCCO   	&&DET VENDITA
      =CARICA_RIEPILOGHI_CONTABILI(V_AOM,'',_SOMMA_W_OMAGGIO,GETDCON(V_AOM))
   	 
      IF _SOMMA_W_IMPOSTA <> 0
	     DO MOVCREA WITH DAVD,_SOMMA_W_IMPOSTA,0,'NO',V_CIO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_OKDIFC,_ARPU,_SOMMA_W_PUBBLI,_SOMMA_W_OMAGGIO,_CODCOMMESSA,Z_CODCCO   	&&DET VENDITA
   	     =CARICA_RIEPILOGHI_CONTABILI(V_CIO,'',_SOMMA_W_IMPOSTA,GETDCON(V_CIO))
      ENDIF
   ENDSCAN
   ...
   *** RAGGRUPPO PER CENTRO DI COSTO
   ...
   SCAN
      ...
      IF _SOMMA_W_IMPOSTA <> 0	
   	      ...
   	      DO movcreat WITH DAVA,_SOMMA_W_IMPOSTA,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA	    &&TESTATA
   	      DO movcreai WITH DAVA,_SOMMA_W_IMPOSTA,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA		&&INDICE
          =CARICA_RIEPILOGHI_CONTABILI(M.CONTO,'',_SOMMA_W_IMPOSTA,GETDCON(M.CONTO))
...
*************************************************************
PROCEDURE CREA_REGISTRAZIONI_PUBBLICITARIO_IVA_CARICO_CLIENTE
*************************************************************
	  ...
	  IF W_PUBBLI <> 0
		...
		*** QUESTA REGOLA E' APPLICATA ALLE SOLE FATTURE
		   ...
		   _SEQUEN =  10
   		   ...
   		   DO movcreat WITH DAVA,VALORE_PUBBLI_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA  	    &&TESTATA
		   DO movcreai WITH DAVA,VALORE_PUBBLI_RICALCOLATO,0,'NO',M.CONTO,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_CODCOMMESSA  		&&INDICE

	       OLD_DESF = XDESF
	       XDESF    = "CLI:"+CERCA_CLI(ALLTRIM(SUBSTR(M.CONTO,PUB_SOTTOG,PUB_CONTO)))+" N.F:"+M.OLFAT+" DEL "+M.DTD
	       XDESF    = DESCRIZIONE_AUTOMATICA(XDESF,ALLTRIM(SUBSTR(M.CONTO,PUB_SOTTOG,PUB_CONTO)),M.OLFAT,M.DTD)  && ERASMO - 07/08/2015
	       
	       DO movcrea WITH DAVD,VALORE_PUBBLI_RICALCOLATO,0,'NO',V_AOC,TOP_GIR,M.DOC,M.DTD,M.OLFAT,XVALUTA,XCAMBIO,_OKDIFC,W_ARPU,VALORE_PUBBLI_RICALCOLATO,W_OMAGGIO,_CODCOMMESSA,Z_CODCCO   	&&DET VENDITA
