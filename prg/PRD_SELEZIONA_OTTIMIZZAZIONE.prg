...
RELEASE _PUB_CURSORE_IN,;
        ...
        _PUB_DESCRIZIONE_BOBINE,;
        _PUB_MAPPA_CAMPI,;
        _PUB_MAPPA_CAMPI_BOBINE,;
        _PUB_FORMHEIGHT,;
        _PUB_FORMWIDTH,;
        _PUB_SELEZIONE,;
...
_PUB_SELEZIONE						=	.F.
_PUB_DIMENSIONE_CARATTERE_TITOLO	=	12	&& DIMENSIONE DI DEFAULT DEL CARATTERE DEL TITOLO
...
_PUB_MAPPA_CAMPI_BOBINE	="MAG_CODART:Cod.,W:15;MAG_ANAART:Articolo,W:10;MAG_ALTEZZ:H(mm),W:7;MAG_LUNGHE:L(ML),W:7;"
_PUB_CURSORE_BOBINE		="BOBINE_DISPONIBILI"
_PUB_DESCRIZIONE_BOBINE ="BOBINE DISPONIBILI"

CREATE CURSOR BRWVORD (CAMPO C(20), HEADER C(120), CAPTORIG C(120), BACKORIG N(10), FOREORIG N(10))

DO FORM form\PRD_SELEZIONA_OTTIMIZZAZIONE LINKED
