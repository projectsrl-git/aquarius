...
*!*	RIT=MESSAGEBOX("Funzione di gestione calcolo bilancio RICLASSIFICATO: continuare con l'elaborazione?",292,"ATTENZIONE")
...
*!*	RIT=MESSAGEBOX("Funzione di gestione calcolo bilancio RICLASSIFICATO: includere movimenti previsionali?",292,"ATTENZIONE")

*!*	IF RIT=6
*!*		_BIL_RICLASSIFICATO_INCLUDI_PREVISIONALI =.T.
*!*	ELSE
*!*	   _BIL_RICLASSIFICATO_INCLUDI_PREVISIONALI =.F.
*!*	ENDIF
...
*!*			CANCELLO LA RIGA DI U_BRI_TT IN CUI NON E' PRESENTE INT_CODRIG
*!*			_csqldelete   = "DELETE FROM U_BRI_TT WHERE INT_CONTO='"+ALLTRIM(V_CONTO)+"' AND INT_CODRIG =''"
