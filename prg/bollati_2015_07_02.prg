...
********************************************************************************************************
*
*!*	VERSIONE CON LA GESTIONE DEL BOLLATO IVA CLIENTI VENDITE IN SOSPENSIONE IVA
*   SCORPOA IL BOLLATO DELLE FATTURE ELETTRONICHE PA DALLE ALTRE FATTURE IN SOSPENSIONE IVA  
...
***    	__PAR_CIVA1 = "SP"	&& CODICE IVA SPLIT PAYMENT
...
********************************************************
   ...
   ** ############################################### AGGIORNA RECORD DETTAGLIO ###############################################
   ...
   WTOP             = M.PAR_TIPFAT
   VNUMPRT			= VAL(M.PAR_NPROT)      			&& NUMERO DI FATTURA
...
IF !EXECCOMMAND("UPDATE U_FOR_AN SET FOR_CLICEE='500000246' WHERE FOR_CODCLI='"+_CODICE_FORNITORE +"' ","U_FOR_AN")
  RETURN(.F.)
ENDIF
